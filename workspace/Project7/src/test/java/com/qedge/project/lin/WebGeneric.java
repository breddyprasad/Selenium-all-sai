...
public class WebGeneric {
	    ...
	    performAction(eleProperty("Login_Username"), propertyValue("Login_Username"),"sendkeys", "admin");
	    performAction(eleProperty("Login_Password"), propertyValue("Login_Password"), "sendkeys", "manager");
	    performAction(eleProperty("Login_LoginButton"), propertyValue("Login_LoginButton"), "click", "");
	    }
